...
public class GoogleConnectionDialog extends javax.swing.JDialog implements ClipboardOwner {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Open following web address:");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        if (codeTF.getText().trim().isEmpty()) {
            int dialogResult = JOptionPane.showConfirmDialog(this, "Authorization code not fille, really close?", "Error", JOptionPane.YES_NO_OPTION);

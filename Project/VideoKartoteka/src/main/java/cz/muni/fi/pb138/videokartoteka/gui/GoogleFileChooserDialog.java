...
import cz.muni.fi.pb138.videokartoteka.gui.components.GoogleDriveTreeModel;
import cz.muni.fi.pb138.videokartoteka.gui.components.GoogleDriveTreeRenderer;
...
public class GoogleFileChooserDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Google Drive file chooser");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        if (pathTF.getText().trim().isEmpty()) {
            int dialogResult = JOptionPane.showConfirmDialog(this, "No file selected, really cancel?", "Error", JOptionPane.YES_NO_OPTION);
